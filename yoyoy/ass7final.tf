...
EOF
  ...
  boot_disk {
    initialize_params {
      image = "projects/project4-414017/global/images/centos-stream9-1718521283"
    }
  }
...
resource "google_dns_record_set" "a_record" {
  ...
  rrdatas = [google_compute_instance.example_instance.network_interface.0.access_config.0.nat_ip]
...
resource "local_file" "rendered_template" {
  content  = templatefile("./function-source/index-template.js", { IP_ADDRESS = google_compute_instance.example_instance.network_interface.0.access_config.0.nat_ip })
